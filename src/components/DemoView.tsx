...
export const DemoView: React.FC = () => {
  ...
  const slideScripts = [
    "Welcome to GitFlow AI, our foundational orchestration layer for the GitLab Hackathon 2026. We focus on the high-friction gap between code completion and production deployment. Our mission is to eliminate 'Merge Hell' for large-scale engineering teams.",
    "The core problem is the coordination bottleneck. In large organizations, merging dozens of branches manually is staggering and leads to broken pipelines. GitFlow AI uses Gemini to understand intent, automating the complex logic of large-scale synchronization.",
    "Our architecture acts as an intelligence layer between your teams and the GitLab API. Gemini 3.1 Pro manages merge queues, resolves conflicts, and provides real-time diagnostics. All system state is persisted in GitHub, providing a transparent audit trail of every AI decision.",
